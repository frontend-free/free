import{i as v,j as e,k as N,l as x,m as j,n as h,p as S,q as b,s as l,t as C,v as w,w as _,r as y}from"./iframe-D8zT026r.js";import"./preload-helper-D9Z9MdNV.js";const J={title:"@fe-free/core/Form",component:v,tags:["autodocs"],parameters:{docs:{description:{component:"Form 组件基于 Ant Design ProForm，支持多种表单类型和扩展字段，适用于复杂表单场景。"}}}};function o({children:P,initialValues:s}){const[n,F]=y.useState(void 0);return e.jsxs(v,{initialValues:s,onValuesChange:a=>{F({...n,...a})},onFinish:a=>{console.log("values",a)},children:[e.jsxs("pre",{children:["values: ",JSON.stringify(n,null,2)]}),P]})}const t={render:()=>e.jsx(o,{initialValues:{code:`const name = 'world';
console.log('hello', name);
`},children:e.jsx(N,{name:"code",fieldProps:{language:"javascript",height:"400px"}})})},m={render:()=>e.jsxs(o,{initialValues:{json:JSON.stringify({name:"world"},null,2)},children:[e.jsx(x,{name:"json"}),e.jsx("div",{children:"readonly"}),e.jsx(x,{name:"json",readonly:!0,initialValue:JSON.stringify({name:"world"},null,2),fieldProps:{mainMenuBar:!1,readonly:!0}})]})},i={render:()=>e.jsxs(o,{initialValues:{javascript:`const name = 'world';
console.log('hello', name);
`},children:[e.jsx(j,{name:"javascript"}),e.jsx("div",{children:"readonly"}),e.jsx(j,{name:"javascript",readonly:!0})]})},d={render:()=>e.jsxs(o,{children:[e.jsx(h,{name:"switchNumber"}),e.jsx(h,{name:"switchNumber",fieldProps:{checkedChildren:"开启",unCheckedChildren:"关闭"}})]})},c={render:()=>e.jsx(o,{children:e.jsx(S,{name:"listText"})})},p={render:()=>e.jsxs(o,{children:[e.jsx(b,{name:"listNumber",label:"listNumber"}),e.jsx(b,{name:"listInteger",label:"listInteger",fieldProps:{precision:0}})]})};function r(P){const{file:s,onProgress:n,onSuccess:F}=P;let a=0;const f=setInterval(()=>{a+=10,n({percent:a}),a>=100&&(clearInterval(f),F({data:{url:`https://picsum.photos/200/300?random=${Date.now()}`,name:s.name,uid:s.uid}}))},100);return{abort:()=>{clearInterval(f),console.log("上传已取消")}}}const u={render:()=>e.jsxs(o,{children:[e.jsx(l,{label:"file",name:"file",fieldProps:{customRequest:r}}),e.jsx(C,{label:"file_dragger",name:"file_dragger",fieldProps:{customRequest:r}}),e.jsx(C,{label:"files_dragger",name:"files_dragger",fieldProps:{multiple:!0,maxCount:2,customRequest:r}}),e.jsx(l,{label:"files",name:"files",fieldProps:{multiple:!0,maxCount:2,showCount:!0,customRequest:r}}),e.jsx(l,{label:"files_picture",name:"files_picture",fieldProps:{multiple:!0,maxCount:2,listType:"picture",customRequest:r}}),e.jsx(l,{label:"files_picture_card",name:"files_picture_card",fieldProps:{multiple:!0,maxCount:2,listType:"picture-card",customRequest:r}})]})},g={render:()=>e.jsxs(o,{children:[e.jsx(w,{label:"image",name:"image",fieldProps:{customRequest:r}}),e.jsx(_,{label:"image_dragger",name:"image_dragger",fieldProps:{customRequest:r}}),e.jsx(_,{label:"images_dragger",name:"images_dragger",fieldProps:{multiple:!0,maxCount:2,customRequest:r}})]})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
...
}`,...g.parameters?.docs?.source}}};const I=["ProFormEditorComponent","ProFormJSONComponent","ProFormJavascriptComponent","ProFormSwitchNumberComponent","ProFormListTextComponent","ProFormListNumberComponent","ProFormUploadComponent","ProFormImageUploadComponent"];export{t as ProFormEditorComponent,g as ProFormImageUploadComponent,m as ProFormJSONComponent,i as ProFormJavascriptComponent,p as ProFormListNumberComponent,c as ProFormListTextComponent,d as ProFormSwitchNumberComponent,u as ProFormUploadComponent,I as __namedExportsOrder,J as default};
