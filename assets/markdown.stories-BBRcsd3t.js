import{M as r,r as s,j as d}from"./iframe-BYmmJCK5.js";import"./index-3B5YSl0e.js";import"./preload-helper-PPVm8Dsz.js";const h={title:"@fe-free/core/Markdown",component:r,tags:["autodocs"]};function l(a){const[o,c]=s.useState(0);return s.useEffect(()=>{setInterval(()=>{c(g=>g+1)},50)},[]),d.jsx(r,{...a,content:a.content.slice(0,o),isStreaming:o!==a.content.length})}const n={args:{content:`
# Markdown 组件示例
...
}`,...t.parameters?.docs?.source}}};const k=["Default","Streaming","Latex","Think"];export{n as Default,i as Latex,e as Streaming,t as Think,k as __namedExportsOrder,h as default};
