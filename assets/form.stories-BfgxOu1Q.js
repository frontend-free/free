import{j as e}from"./jsx-runtime-DYO6iK1c.js";import{i as N,j as v,k as x,l as j,m as h,n as S,p as b,q as m,r as C,s as w,t as _}from"./localforage-BTF3Q14z.js";import"./environment-Bn1z5B45.js";import"./_commonjs-dynamic-modules-BzUgh-JK.js";import{r as y}from"./iframe-C5YgwIi3.js";import"./isNumber-Hrl3mtTe.js";import"./index-CIRwY3z5.js";import"./index-x4HnuTdD.js";import"./preload-helper-D9Z9MdNV.js";const L={title:"@fe-free/core/Form",component:N,tags:["autodocs"],parameters:{docs:{description:{component:"Form 组件基于 Ant Design ProForm，支持多种表单类型和扩展字段，适用于复杂表单场景。"}}}};function o({children:P,initialValues:s}){const[n,f]=y.useState(void 0);return e.jsxs(N,{initialValues:s,onValuesChange:a=>{f({...n,...a})},onFinish:a=>{console.log("values",a)},children:[e.jsxs("pre",{children:["values: ",JSON.stringify(n,null,2)]}),P]})}const t={render:()=>e.jsx(o,{initialValues:{code:`const name = 'world';
