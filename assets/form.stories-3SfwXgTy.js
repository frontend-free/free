import{j as e}from"./jsx-runtime-CiWyWcYn.js";import{h as N,i as v,j as x,k as j,l as h,m as S,n as b,p as m,q as C,r as w,s as _}from"./localforage-DKSIyaZS.js";import"./environment-BmJygpxs.js";import"./_commonjs-dynamic-modules-j8mxCgBL.js";import{r as y}from"./iframe-DvbrA2Lz.js";import"./isNumber-DFj8Bs4M.js";import"./index-DXYzE9xC.js";import"./index-CJIHt5Im.js";import"./preload-helper-D9Z9MdNV.js";const L={title:"@fe-free/core/Form",component:N,tags:["autodocs"],parameters:{docs:{description:{component:"Form 组件基于 Ant Design ProForm，支持多种表单类型和扩展字段，适用于复杂表单场景。"}}}};function o({children:P,initialValues:s}){const[n,f]=y.useState(void 0);return e.jsxs(N,{initialValues:s,onValuesChange:a=>{f({...n,...a})},onFinish:a=>{console.log("values",a)},children:[e.jsxs("pre",{children:["values: ",JSON.stringify(n,null,2)]}),P]})}const t={render:()=>e.jsx(o,{initialValues:{code:`const name = 'world';
