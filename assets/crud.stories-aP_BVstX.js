import{j as e}from"./jsx-runtime-BjgbQsUx.js";import{_ as ne,P as oe,a as b,l as a,B,k as de}from"./pro_form_switch_number-CJgPRvkG.js";import{a as ce}from"./filter-Dynzr6vS.js";import"./date-DJ5b9kEY.js";import"./isNumber-Dc4sICNo.js";import{R as ue,r as te}from"./index-BTkrZ5ys.js";import{f as n,a as C,d as f,b as R,e as I,l as le,g as ie,h as me,i as pe}from"./data-CFFHqrXP.js";import{W as P}from"./index-BAVRLWN0.js";import"./index-D2MAbzvX.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-BqOStK5P.js";import"./index-BIm0odtm.js";import"./iframe-WH9UTmjB.js";import"../sb-preview/runtime.js";var xe=["fieldProps","unCheckedChildren","checkedChildren","proFieldProps"],he=ue.forwardRef(function(t,r){var s=t.fieldProps,o=t.unCheckedChildren,re=t.checkedChildren,ae=t.proFieldProps,se=ne(t,xe);return e.jsx(oe,b({valueType:"switch",fieldProps:b({unCheckedChildren:o,checkedChildren:re},s),ref:r,valuePropName:"checked",proFieldProps:ae,filedConfig:{valuePropName:"checked",ignoreWidth:!0,customLightMode:!0}},se))});const d={fieldProps:{showSearch:!0,filterOption:(t,r)=>ce(r.label,t),fetchDataOnSearch:!1}},De={title:"@fe-free/core/CRUD",component:a,tags:["autodocs"]},c={render:()=>{const t=[{title:"id",dataIndex:"id",search:!0},{title:"名字(省略)",dataIndex:"name",search:!0,ellipsis:!0},{title:"city",dataIndex:"city"},{title:"area",dataIndex:"area"}];return e.jsx(a,{actions:["create","read","delete","update"],tableProps:{columns:t,request:n},requestDeleteByRecord:C,deleteProps:{nameIndex:"name"},detailForm:r=>e.jsx(e.Fragment,{children:e.jsx(P,{...r,name:"name",label:"名字",required:!0,rules:[{required:!0}],extra:"extra extra extra extra"})}),requestGetByRecord:f,requestCreateByValues:R,requestUpdateById:I})}},u={render:()=>{const t=[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}];return e.jsx(a,{actions:["read_detail"],tableProps:{columns:t,request:n}})}},l={render:()=>e.jsx(a,{actions:["batch_delete"],tableProps:{columns:[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}],request:n},requestDeleteByRecords:async t=>{console.log(t)}})},i={render:()=>{const t=[{title:"id",dataIndex:"id",search:!0},{title:"名字(省略)",dataIndex:"name",search:!0,ellipsis:!0},{title:"city",dataIndex:"city"},{title:"area",dataIndex:"area"}];return e.jsx(a,{actions:["create","read","delete","update"],tableProps:{columns:t,request:n,toolBarRender:()=>[e.jsx("div",{children:"自定义1"},"custom1"),e.jsx("div",{children:"自定义2"},"custom2")]},operateColumnProps:{width:300,moreOperator:()=>e.jsx("div",{children:"自定义"}),moreOperatorAfter:()=>e.jsx("div",{children:"自定义"})},createButton:e.jsx(B,{type:"primary",children:"自定义新建文本"}),requestDeleteByRecord:C,deleteProps:{nameIndex:"name"},detailForm:r=>e.jsx(e.Fragment,{children:e.jsx(P,{...r,name:"name",label:"名字",required:!0,rules:[{required:!0}],extra:"extra extra extra extra"})}),requestGetByRecord:f,requestCreateByValues:R,requestUpdateById:I})}},ye=()=>{const t=te.useRef(),[r]=de.useForm(),s=[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}];return e.jsx(a,{actions:["create","read","update"],tableProps:{formRef:t,columns:s,request:n},detailFormInstance:r,detailForm:o=>e.jsxs(e.Fragment,{children:[e.jsx(P,{...o,name:"name",label:"名字",required:!0,rules:[{required:!0}],initialValue:"default"}),e.jsx(he,{...o,name:"status",label:"开启",initialValue:!1})]}),requestGetByRecord:f,requestCreateByValues:R,requestUpdateByValues:I})},m={render:()=>e.jsx(ye,{})},qe=()=>{const t=te.useRef(),r=[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}];return e.jsxs(e.Fragment,{children:[e.jsx(B,{onClick:()=>{var s;return(s=t.current.getActionRef().current)==null?void 0:s.reload()},children:"reload"}),e.jsx(a,{ref:t,actions:[],tableProps:{columns:r,request:n}})]})},p={render:()=>e.jsx(qe,{})},x={render:()=>{const t=[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0},{title:"等级(本地数据)",dataIndex:"level",search:!0,valueEnum:le,...d},{title:"city(远端数据)",dataIndex:"city",search:!0,request:async()=>(await ie()).map(s=>({label:s,value:s})),...d},{title:"area(联动 city)",dataIndex:"area",search:!0,request:async r=>(await me(r)).map(o=>({label:o,value:o})),dependencies:["city"],...d},{title:"学校(远端数据 label value)",dataIndex:"school",search:!0,valueType:"select",request:()=>pe(),...d}];return e.jsx(a,{actions:[],tableProps:{columns:t,request:n}})}},h={render:()=>{const t=[{title:"id",dataIndex:"id"},{title:"名字",dataIndex:"name"}];return e.jsx(a,{actions:[],tableProps:{columns:t,request:n,search:!1}})}},y={render:()=>{const t=[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}];return e.jsx(a,{actions:["create","read","delete","update"],tableProps:{columns:t,request:n},createButton:e.jsx(B,{type:"primary",children:"新建"}),createProps:{submitText:"自定义新建确定",resetText:"自定义新建取消"},readProps:{submitText:"自定义查看确定",resetText:"自定义查看取消",operateText:"查看"},deleteProps:{nameIndex:"name",operateText:"删除",desc:"确定要删除吗？"},updateProps:{operateText:"编辑",submitText:"自定义编辑确定",resetText:"自定义编辑取消",successText:"编辑成功"},requestDeleteByRecord:C,detailForm:r=>e.jsx(e.Fragment,{children:e.jsx(P,{...r,name:"name",label:"名字",required:!0,rules:[{required:!0}]})}),requestGetByRecord:f,requestCreateByValues:R,requestUpdateByValues:I})}},q={render:()=>e.jsx(a,{actions:[],tableProps:{columns:[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}],request:n},batchActions:[{btnText:"批量xxx",onClick:async(t,{selectedRowKeys:r})=>{console.log(r)}},{btnText:"批量danger",danger:!0,onClick:async(t,{selectedRowKeys:r})=>{console.log(r)}}]})};var k,F,j;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => {
    const columns = [{
      title: 'id',
      dataIndex: 'id',
...
}`,...(j=(F=c.parameters)==null?void 0:F.docs)==null?void 0:j.source}}};var T,v,g;u.parameters={...u.parameters,docs:{...(T=u.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => {
    const columns = [{
      title: 'id',
      dataIndex: 'id',
...
}`,...(g=(v=u.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};var S,D,U;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => {
...
}`,...(U=(D=l.parameters)==null?void 0:D.docs)==null?void 0:U.source}}};var w,V,A;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => {
    const columns = [{
      title: 'id',
      dataIndex: 'id',
