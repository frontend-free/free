import{h as S,j as e,i as V,k as w,l as v,m as _,n as a,o as y,p as s,q as k,s as l,t as h,u as R,v as B,w as U,x as C,y as N,r as T}from"./iframe-DPaKIVHw.js";import{s as A}from"./index-mAKpSMLY.js";import"./preload-helper-PPVm8Dsz.js";const M={title:"@fe-free/core/Form",component:S,tags:["autodocs"],parameters:{docs:{description:{component:"Form 组件基于 Ant Design ProForm，支持多种表单类型和扩展字段，适用于复杂表单场景。"}}}};function r({children:x,initialValues:f}){const[L,O]=T.useState(void 0);return e.jsxs(S,{initialValues:f,onValuesChange:j=>{O(j)},onFinish:j=>{console.log("values",j)},children:[e.jsxs("pre",{children:["values: ",JSON.stringify(L,null,2)]}),x]})}const n={render:()=>e.jsx(r,{initialValues:{code:`const name = 'world';
