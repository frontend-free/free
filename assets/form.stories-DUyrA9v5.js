import{g as k,j as e,h as R,i as B,k as C,l as y,m as l,n as L,o as S,p as U,q as n,s as v,t as A,u as _,v as I,w as N,x as O,r as J}from"./iframe-BJkDedAU.js";import"./preload-helper-PPVm8Dsz.js";const M={title:"@fe-free/core/Form",component:k,tags:["autodocs"],parameters:{docs:{description:{component:"Form 组件基于 Ant Design ProForm，支持多种表单类型和扩展字段，适用于复杂表单场景。"}}}};function r({children:b,initialValues:s}){const[j,h]=J.useState(void 0);return e.jsxs(k,{initialValues:s,onValuesChange:a=>{h(a)},onFinish:a=>{console.log("values",a)},children:[e.jsxs("pre",{children:["values: ",JSON.stringify(j,null,2)]}),b]})}const t={render:()=>e.jsx(r,{initialValues:{code:`const name = 'world';
console.log('hello', name);
`},children:e.jsx(R,{name:"code",fieldProps:{language:"javascript",height:"400px"}})})},i={render:()=>e.jsxs(r,{initialValues:{json:JSON.stringify({name:"world"},null,2)},children:[e.jsx(B,{name:"json"}),e.jsx("div",{children:"readonly"}),e.jsx(B,{name:"json",readonly:!0,initialValue:JSON.stringify({name:"world"},null,2),fieldProps:{mainMenuBar:!1,readonly:!0}})]})},m={render:()=>e.jsxs(r,{initialValues:{javascript:`const name = 'world';
console.log('hello', name);
