import{j as e}from"./jsx-runtime-BS3Pf2L2.js";import{i as N,j as v,k as x,l as j,m as h,n as S,p as b,q as m,r as C,s as w,t as _}from"./localforage-CdvHuRk1.js";import"./environment-D1Tetxq3.js";import"./_commonjs-dynamic-modules-CJKkAwsZ.js";import{r as y}from"./iframe-D6LNibMz.js";import"./isNumber-CYiX0U_A.js";import"./index-a7ffcrXW.js";import"./index-BTD-g_8Y.js";import"./preload-helper-D9Z9MdNV.js";const L={title:"@fe-free/core/Form",component:N,tags:["autodocs"],parameters:{docs:{description:{component:"Form 组件基于 Ant Design ProForm，支持多种表单类型和扩展字段，适用于复杂表单场景。"}}}};function o({children:P,initialValues:s}){const[n,f]=y.useState(void 0);return e.jsxs(N,{initialValues:s,onValuesChange:a=>{f({...n,...a})},onFinish:a=>{console.log("values",a)},children:[e.jsxs("pre",{children:["values: ",JSON.stringify(n,null,2)]}),P]})}const t={render:()=>e.jsx(o,{initialValues:{code:`const name = 'world';
