import{j as e}from"./jsx-runtime-BjgbQsUx.js";import{_ as re,P as te,a as C,l as s,B as X,k as ae}from"./pro_form_switch_number-BK2n5nEX.js";import{a as se}from"./filter-Dynzr6vS.js";import"./date-DJ5b9kEY.js";import"./isNumber-Dc4sICNo.js";import{R as ne,r as Y}from"./index-BTkrZ5ys.js";import{f as n,a as P,d as y,b as f,e as R,l as oe,g as de,h as ce,i as ue}from"./data-DSfMXt5K.js";import{W as I}from"./index-CC64QoD7.js";import"./index-D2MAbzvX.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-BqOStK5P.js";import"./index-BIm0odtm.js";import"./iframe-e3eL5yDf.js";import"../sb-preview/runtime.js";var le=["fieldProps","unCheckedChildren","checkedChildren","proFieldProps"],ie=ne.forwardRef(function(r,t){var a=r.fieldProps,o=r.unCheckedChildren,Z=r.checkedChildren,$=r.proFieldProps,ee=re(r,le);return e.jsx(te,C({valueType:"switch",fieldProps:C({unCheckedChildren:o,checkedChildren:Z},a),ref:t,valuePropName:"checked",proFieldProps:$,filedConfig:{valuePropName:"checked",ignoreWidth:!0,customLightMode:!0}},ee))});const d={fieldProps:{showSearch:!0,filterOption:(r,t)=>se(t.label,r),fetchDataOnSearch:!1}},ve={title:"@fe-free/core/CRUD",component:s,tags:["autodocs"]},c={render:()=>{const r=[{title:"id",dataIndex:"id",search:!0},{title:"名字(省略)",dataIndex:"name",search:!0,ellipsis:!0},{title:"city",dataIndex:"city"},{title:"area",dataIndex:"area"}];return e.jsx(s,{actions:["create","read","delete","update"],tableProps:{columns:r,request:n},requestDeleteByRecord:P,deleteProps:{nameIndex:"name"},detailForm:t=>e.jsx(e.Fragment,{children:e.jsx(I,{...t,name:"name",label:"名字",required:!0,rules:[{required:!0}],extra:"extra extra extra extra"})}),requestGetByRecord:y,requestCreateByValues:f,requestUpdateById:R})}},u={render:()=>{const r=[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}];return e.jsx(s,{actions:["read_detail"],tableProps:{columns:r,request:n}})}},l={render:()=>{const r=[{title:"id",dataIndex:"id",search:!0},{title:"名字(省略)",dataIndex:"name",search:!0,ellipsis:!0},{title:"city",dataIndex:"city"},{title:"area",dataIndex:"area"}];return e.jsx(s,{actions:["create","read","delete","update"],tableProps:{columns:r,request:n,toolBarRender:()=>[e.jsx("div",{children:"自定义1"},"custom1"),e.jsx("div",{children:"自定义2"},"custom2")]},operateColumnProps:{width:300,moreOperator:()=>e.jsx("div",{children:"自定义"}),moreOperatorAfter:()=>e.jsx("div",{children:"自定义"})},requestDeleteByRecord:P,deleteProps:{nameIndex:"name"},detailForm:t=>e.jsx(e.Fragment,{children:e.jsx(I,{...t,name:"name",label:"名字",required:!0,rules:[{required:!0}],extra:"extra extra extra extra"})}),requestGetByRecord:y,requestCreateByValues:f,requestUpdateById:R})}},me=()=>{const r=Y.useRef(),[t]=ae.useForm(),a=[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}];return e.jsx(s,{actions:["create","read","update"],tableProps:{formRef:r,columns:a,request:n},detailFormInstance:t,detailForm:o=>e.jsxs(e.Fragment,{children:[e.jsx(I,{...o,name:"name",label:"名字",required:!0,rules:[{required:!0}],initialValue:"default"}),e.jsx(ie,{...o,name:"status",label:"开启",initialValue:!1})]}),requestGetByRecord:y,requestCreateByValues:f,requestUpdateByValues:R})},i={render:()=>e.jsx(me,{})},pe=()=>{const r=Y.useRef(),t=[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}];return e.jsxs(e.Fragment,{children:[e.jsx(X,{onClick:()=>{var a;return(a=r.current.getActionRef().current)==null?void 0:a.reload()},children:"reload"}),e.jsx(s,{ref:r,actions:[],tableProps:{columns:t,request:n}})]})},m={render:()=>e.jsx(pe,{})},p={render:()=>{const r=[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0},{title:"等级(本地数据)",dataIndex:"level",search:!0,valueEnum:oe,...d},{title:"city(远端数据)",dataIndex:"city",search:!0,request:async()=>(await de()).map(a=>({label:a,value:a})),...d},{title:"area(联动 city)",dataIndex:"area",search:!0,request:async t=>(await ce(t)).map(o=>({label:o,value:o})),dependencies:["city"],...d},{title:"学校(远端数据 label value)",dataIndex:"school",search:!0,valueType:"select",request:()=>ue(),...d}];return e.jsx(s,{actions:[],tableProps:{columns:r,request:n}})}},x={render:()=>{const r=[{title:"id",dataIndex:"id"},{title:"名字",dataIndex:"name"}];return e.jsx(s,{actions:[],tableProps:{columns:r,request:n,search:!1}})}},h={render:()=>{const r=[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}];return e.jsx(s,{actions:["create","read","delete","update"],tableProps:{columns:r,request:n},createButton:e.jsx(X,{type:"primary",children:"新建"}),createProps:{submitText:"自定义新建确定",resetText:"自定义新建取消"},readProps:{submitText:"自定义查看确定",resetText:"自定义查看取消",operateText:"查看"},deleteProps:{nameIndex:"name",operateText:"删除",desc:"确定要删除吗？"},updateProps:{operateText:"编辑",submitText:"自定义编辑确定",resetText:"自定义编辑取消",successText:"编辑成功"},requestDeleteByRecord:P,detailForm:t=>e.jsx(e.Fragment,{children:e.jsx(I,{...t,name:"name",label:"名字",required:!0,rules:[{required:!0}]})}),requestGetByRecord:y,requestCreateByValues:f,requestUpdateByValues:R})}},q={render:()=>e.jsx(s,{actions:[],tableProps:{columns:[{title:"id",dataIndex:"id",search:!0},{title:"名字",dataIndex:"name",search:!0}],request:n},batchActions:[{btnText:"批量删除",danger:!0,onClick:async(r,{selectedRowKeys:t})=>{console.log(t)}}]})};var B,k,b;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => {
    const columns = [{
      title: 'id',
      dataIndex: 'id',
...
}`,...(G=(A=m.parameters)==null?void 0:A.docs)==null?void 0:G.source}}};var O,N,_;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => {
...
}`,...(_=(N=p.parameters)==null?void 0:N.docs)==null?void 0:_.source}}};var E,M,W;x.parameters={...x.parameters,docs:{...(E=x.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => {
    const columns = [{
      title: 'id',
      dataIndex: 'id'
...
}`,...(W=(M=x.parameters)==null?void 0:M.docs)==null?void 0:W.source}}};var K,L,z;h.parameters={...h.parameters,docs:{...(K=h.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: () => {
    const columns = [{
      title: 'id',
      dataIndex: 'id',
...
}`,...(Q=(J=q.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};const Te=["Normal","ReadDetail","MoreCustom","FormRef","ActionRef","RemoteData","NoSearch","CustomText","RowSelection"];export{m as ActionRef,h as CustomText,i as FormRef,l as MoreCustom,x as NoSearch,c as Normal,u as ReadDetail,p as RemoteData,q as RowSelection,Te as __namedExportsOrder,ve as default};
