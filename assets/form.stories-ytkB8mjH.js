import{j as e}from"./jsx-runtime-B1QcgMW2.js";import{i as N,j as v,k as x,l as j,m as h,n as S,p as b,q as m,r as C,s as w,t as _}from"./localforage-506RbLy7.js";import"./environment-BScw_WLC.js";import"./_commonjs-dynamic-modules-BzqG4ut3.js";import{r as y}from"./iframe-CEWcoWJK.js";import"./isNumber-Ct9g_Odi.js";import"./index-Cu_UTL25.js";import"./index-_x-X8Tem.js";import"./preload-helper-D9Z9MdNV.js";const L={title:"@fe-free/core/Form",component:N,tags:["autodocs"],parameters:{docs:{description:{component:"Form 组件基于 Ant Design ProForm，支持多种表单类型和扩展字段，适用于复杂表单场景。"}}}};function o({children:P,initialValues:s}){const[n,f]=y.useState(void 0);return e.jsxs(N,{initialValues:s,onValuesChange:a=>{f({...n,...a})},onFinish:a=>{console.log("values",a)},children:[e.jsxs("pre",{children:["values: ",JSON.stringify(n,null,2)]}),P]})}const t={render:()=>e.jsx(o,{initialValues:{code:`const name = 'world';
